    ...
    return [
      {
        ...
        _id: getID(),
        text:
          "Okay, so, one way to avoid napping is to engage in another activity incompatible with napping when the get to urge to sleep during the day",
        otherUser,
        quickReplies: {
          type: "radio", // or 'checkbox',
          keepIt: true,
    ...
    return [
      {
        ...
        _id: getID(),
        text:
          "It is important to know the difference between time spent sleeping and time spent in bed. Would you like to work on your sleep efficiency?",
        otherUser,
        quickReplies: {
          type: "radio", // or 'checkbox',
          keepIt: true,
